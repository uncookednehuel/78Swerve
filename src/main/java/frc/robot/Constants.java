...
public final class Constants {
    ...
    public static final double maxSpeed = 6380.0 / 60.0 * Swerve.DRIVE_GEAR_RATIO * 0.1016 * Math.PI; //meters per second
    //#endregion
     ...
     public static final double X_ERROR_VEL = 1; // I don't know what "additional meter per second in the x direction for every meter of error in the x direction" means in the docs
