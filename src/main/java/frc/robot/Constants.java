...
public final class Constants {
    ...
    // public static final double offsetRD = Math.toRadians(0) * -1; // maybe substract 180
    ...
    public static final double offsetRD = Math.toRadians(344.35) * -1; // maybe substract 180
