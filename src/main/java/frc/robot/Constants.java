...
public final class Constants {
    ...
    public static final Mk4SwerveModuleHelper.GearRatio swerveGearRatio = Mk4SwerveModuleHelper.GearRatio.L2;
     ...
     public static final double xErrVel = 0.2; // I don't know what "additional meter per second in the x direction for every meter of error in the x direction" means in the docs
     public static final double yErrVel = 0.2;
